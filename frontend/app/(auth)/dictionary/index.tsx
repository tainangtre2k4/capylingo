            ...
            header: () => (
                <View style={styles.headerContainer}>
                    ...
                    <View style={styles.headerIconsContainer}>
                        <TouchableOpacity style={styles.headerIcon} activeOpacity={0.6}>
                            <Ionicons name='time' size={24} color='#0693F1'/>
                        </TouchableOpacity>
        ...
        <View style={styles.container}>
            <View style={styles.inputContainer}>
                <TextInput
                    ...
                    style={styles.input}
                    placeholder="Search..."
                    value={newWord} // Ensure value is controlled
            ...
            {newWord ? ( // Conditionally render the clear button
