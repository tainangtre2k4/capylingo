...
const ListeningQuestionSheet = () => {
    const navigation = useNavigation();
    const { curIndex, maxIndex, answers, questionSheet, timeRemaining, setAnswers, setTimeRemaining } = useContext(ListeningContext);
    const fontSize = 14;
...
export default ListeningQuestionSheet;
